...
<body>
	...
	<img src="logo.png">
		...
		<input type="submit" value="Buscar" name="btnbuscar"><input type="text" name="txtbuscar" id="cajabuscar" placeholder="&#128270;Buscar por imei">
		</form>
		</div>
...
<div class="caja_popup" id="formregistrar">
  <form action="agregar.php" class="contenedor_popup" method="POST">
		...
		<tr><th colspan="2">Nuevo usuario</th></tr>
            <tr> 
                <td>Imei</td>
                <td><input type="number" name="txtimei" required></td>
            </tr>
            <tr> 
                <td>Nombre</td>
            ...
            <tr> 
                <td>Unlocked</td>
                <td><input type="text" name="txtunlocked" required></td>
            </tr>
            <tr> 	
               <td colspan="2">
